...
(truelabels, images) = dataset.build_batch(imagePaths, conf["googlenet_fixed_size"])
features = oe.describe(images)
controlImages = dataset.build_batch_control_evaluation(imagePaths, conf["googlenet_fixed_size"])
