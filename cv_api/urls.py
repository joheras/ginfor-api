...
urlpatterns = [
    ...
    url(r'^fungi_classification/predictFungiClass/zip/$',
        fungi_classification.views.predictFungiClassUsingOverfeatViewZIP, name='zip'),
    url(r'^fungi_classification/predictFungiClass/$', fungi_classification.views.predictFungiClassUsingOverfeatView, name='main'),
